...
public partial class WifiFingerprintModel
{
    ...
    private static readonly string MLNetModelPath = Path.GetFullPath(@$"{AppDomain.CurrentDomain.BaseDirectory}\IWNA\ML\Models\WifiFingerprintModel.zip");
    ...
    public class ModelInput
    {
        ...
        [ColumnName(@"col2")] public float Col2 { get; set; }
    }
